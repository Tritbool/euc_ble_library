...
object BLEConstants {
    ...
    // Frame header magic bytes for each protocol — available as a canonical reference to avoid
    // scattering magic bytes across protocol files.
    ...
    // Header bytes alone cannot disambiguate Kingsong from Gotway; the Gotway 5A5A5A5A footer
    // and GATT fingerprinting are the primary disambiguation mechanisms.
